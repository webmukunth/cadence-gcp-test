...
public class ObservabilityAutoConfiguration {
  ...
  public Scope metricScope(@Autowired MeterRegistry meterRegistry) {
    ...
    final var ret = sb.reporter(new MicrometerClientStatsReporter(meterRegistry))
  ...
  MeterRegistryCustomizer<MeterRegistry> metricsCommonTags() {
    return registry -> registry.config().commonTags(
        Tags.COMPONENT.getKey(), "temporal",
  ...
  static class PublishToPrometheusReporter implements StatsReporter {
    ...
    public void reportHistogramValueSamples(String name, Map<String, String> tags, ImmutableBuckets buckets,
    ...
    public void reportHistogramDurationSamples(String name, Map<String, String> tags,
                                               ImmutableBuckets buckets, Duration bucketLowerBound, Duration bucketUpperBound, long samples) {
      final var metricName = TraceUtil.standardMetricName(name);
