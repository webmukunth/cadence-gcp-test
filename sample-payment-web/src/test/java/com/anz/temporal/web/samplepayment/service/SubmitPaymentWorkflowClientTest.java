...
import com.anz.temporal.commons.model.payment.ComAnzFromAcctType;
import com.anz.temporal.commons.model.payment.ComAnzPmtAddRqType;
import com.anz.temporal.commons.model.payment.ComAnzReqMsgHdrType;
...
@ComponentScan(basePackages = "com.anz",
    ...
    excludeFilters = {
        @Filter(type = REGEX, pattern = "com.anz.temporal.commons.autoconfigure.TemporalAutoConfiguration"),
        @Filter(type = REGEX, pattern = "com.anz.temporal.commons.autoconfigure.JacksonXMLAutoConfiguration"),
        @Filter(type = REGEX, pattern = "com.anz.temporal.commons.autoconfigure.KafkaAutoConfiguration"),
        @Filter(type = REGEX, pattern = "com.anz.temporal.commons.autoconfigure.TemporalAutoConfiguration"),
        @Filter(type = REGEX, pattern = "com.anz.temporal.commons.autoconfigure.ObservabilityAutoConfiguration")
    })
@DataMongoTest
